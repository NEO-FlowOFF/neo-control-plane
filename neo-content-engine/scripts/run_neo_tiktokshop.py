...
def main() -> int:
    ...
    for product, queue_row in queued_items:
        ...
        try:
            ...
            if upload_enabled and minio_client is not None:
                ...
                result["video_url"] = build_public_url(endpoint_raw, bucket, object_video)
                result["meta_url"] = build_public_url(endpoint_raw, bucket, object_meta)
